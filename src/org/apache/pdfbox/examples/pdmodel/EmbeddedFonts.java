 ...
 * 
 * ttfファイルを読み込み、Unicodeテキストの内容をPDFファイルに出力する例。
 *
 * @author Keiji Suzuki
 * @author John Hewson
 */
public final class EmbeddedFonts
{
    ...
    public static void main(String[] args) throws IOException
    {
        try (PDDocument document = new PDDocument())
        {
            ...
            String dir ="C:/DiskImage/ApachePDFBox/examples/src/main/resources/org/apache/pdfbox/resources/ttf/";
            PDType0Font font = PDType0Font.load(document, new File(dir + "LiberationSans-Regular.ttf"));
            //PDType0Font font = PDType0Font.load(document, new File(dir + "Lohit-Bengali.ttf"));
